 ...
 */
public class Intendente extends Trabajadores{
    /* Atributos */
    private String area;
    
    /* Constructor */

    public Intendente(String area, float sueldo, String rfc, String horario, String profesion, String puesto, String name, int codigo, String correo, byte edad, char sexo, String telefono, String ocupacion, String domicilio, String curp, String imss) {
    ...
    @Override
    public void accion() {
        System.out.println("Los intendentes tienen hambre de poder");
    }
    
} // Fin de clase intendente
