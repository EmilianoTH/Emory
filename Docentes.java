 ...
 * @author Emiliano
 */
public class Docentes extends Trabajadores{
    /* Atributos */
    private String[] materias;
    private String categoria;
    private String cubiculo; //Atributo que no siempre se usara
    
    /* Constructor */
    public Docentes(int numMaterias, String categoria, String cubiculo, float sueldo, String rfc, String horario, String profesion, String puesto, String name, int codigo, String correo, byte edad, char sexo, String telefono, String ocupacion, String domicilio, String curp, String imss) {
    ...
    public void setCategoria(String categoria) {
        if(categoria.matches("[\\w\\s]+"))this.categoria = categoria;
        else throw new IllegalArgumentException("No deje el espacio en blanco de categoria");
    }

    public void setCubiculo(String cubiculo) {
        if(cubiculo.matches("[\\w\\d-]+"))this.cubiculo = cubiculo;
        else throw new IllegalArgumentException("No deje el espacio en blanco de cubiculo");
    }
    ...
    /* Setters y getters herados de trabajadores*/
    @Override
    ...
    @Override
    public void accion() {
        System.out.println("Los docentes quieren salario extra"); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/OverriddenMethodBody
    }
